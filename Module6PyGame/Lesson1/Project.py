...
background_image = pygame.transform.scale(pygame.image.load("Module6PyGame/Lesson1/background.png").convert(),(SCREEN_WIDTH, SCREEN_HEIGHT))
 
wildlife_image = pygame.transform.scale(pygame.image.load("Module6PyGame/Lesson1/tiger.png").convert_alpha(), (220, 220))
 
wildlife_rect = wildlife_image.get_rect(center=(SCREEN_WIDTH // 2,SCREEN_HEIGHT // 2 - 30 ))
